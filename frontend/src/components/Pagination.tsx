  ...
  return (
    <div className="flex justify-center space-x-1 py-6">
      <ReactPaginate
        ...
        nextClassName="h-7 w-7 bg-white hover:bg-rent-pagination-very-light-blue text-rent-pagination-blue rounded-md shadow-md"
        nextLinkClassName="flex items-center justify-center h-full w-full"
        previousClassName="h-7 w-7 bg-white hover:bg-rent-pagination-very-light-blue text-rent-pagination-blue rounded-md shadow-md"
        previousLinkClassName="flex items-center justify-center h-full w-full"
        pageClassName="h-7 w-7 bg-white hover:bg-rent-pagination-very-light-blue text-rent-pagination-blue rounded-md shadow-md"
